...
<p>Tech stack: JUnit 5, Mockito<p></p>
<p></p>Approach: <b>Arrange -> Act -> Assert (AAA)</b></p>
<p></p>Test were written for the service layer. No integration tests for the moment.</p>
